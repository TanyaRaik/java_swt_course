...
public class GroupCreationTests {
  ...
  public void testGroupCreation() throws Exception {
    ...
    wd.findElement(By.name("mobile")).sendKeys("middle");
    wd.findElement(By.name("work")).click();
    wd.findElement(By.name("work")).clear();
    wd.findElement(By.name("work")).sendKeys("work");
    wd.findElement(By.name("fax")).click();
    wd.findElement(By.name("fax")).clear();
    wd.findElement(By.name("fax")).sendKeys("111");
    wd.findElement(By.name("email")).click();
    wd.findElement(By.name("email")).clear();
    wd.findElement(By.name("email")).sendKeys("raik.tatyana@gmail.com");
    wd.findElement(By.name("email2")).click();
    wd.findElement(By.name("email2")).clear();
    wd.findElement(By.name("email2")).sendKeys("raik2@gmail.com");
    wd.findElement(By.name("theform")).click();
    wd.findElement(By.name("email3")).click();
    wd.findElement(By.name("email3")).clear();
    wd.findElement(By.name("email3")).sendKeys("Raik3@gmail.com");
    ...
    wd.findElement(By.name("byear")).sendKeys("1992");
    wd.findElement(By.name("theform")).click();
